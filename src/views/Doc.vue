<template>
    <div class="">
        ...
        <card class="m-top">
            <div id="print">
                <!-- dogovor -->
                <!-- <Dogovor :form="form" :firm="firma_store[firm_id]" /> -->
                <div
                    v-if="flag.dogovor"
                    v-html="dogovor"
                    class="printDogovor"
    ...
    >
        ...
        <template v-slot:footer><Print /></template>
    </modal>
</template>
...
import Checkboxes from '../components/html/Checkboxes.vue'
...
import Dogovor from '../components/app/Dogovor.vue'
export default {
    name: 'doc',
    components: {
        Sel,
            ...
            while (n < 3) {
                html += `<p style="text-align: center">
                        ...
                        <p>
                            ...
                            директора ${
                                this.firma_store[this.firm_id].director[2]
                            },
